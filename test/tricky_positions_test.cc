...
TEST_CASE("Move count is correct in tricky positions", "[position]") {
  {
    ...
    REQUIRE(chess_engine::CountMoves(pos,1) == 32);
    REQUIRE(chess_engine::CountMoves(pos,2) == 824);
    REQUIRE(chess_engine::CountMoves(pos,3) == 26684);
    REQUIRE(chess_engine::CountMoves(pos,4) == 709946);
  ...
  }
  {
    ...
    REQUIRE(chess_engine::CountMoves(pos,1) == 27);
    REQUIRE(chess_engine::CountMoves(pos,2) == 811);
    REQUIRE(chess_engine::CountMoves(pos,3) == 21437);
    REQUIRE(chess_engine::CountMoves(pos,4) == 675643);
  ...
  }
  {
    ...
    REQUIRE(chess_engine::CountMoves(pos,1) == 41);
    REQUIRE(chess_engine::CountMoves(pos,2) == 1648);
    REQUIRE(chess_engine::CountMoves(pos,3) == 62237);
    REQUIRE(chess_engine::CountMoves(pos,4) == 2415901);
  ...
  }
  {
    ...
    REQUIRE(chess_engine::CountMoves(pos,1) == 8);
    REQUIRE(chess_engine::CountMoves(pos,2) == 54);
    REQUIRE(chess_engine::CountMoves(pos,3) == 450);
    REQUIRE(chess_engine::CountMoves(pos,4) == 3416);
  ...
  }
  {
    ...
    REQUIRE(chess_engine::CountMoves(pos,1) == 35);
    REQUIRE(chess_engine::CountMoves(pos,2) == 1097);
    REQUIRE(chess_engine::CountMoves(pos,3) == 38430);
    REQUIRE(chess_engine::CountMoves(pos,4) == 1234330);
